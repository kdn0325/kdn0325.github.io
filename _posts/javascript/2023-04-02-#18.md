---
title:  "#18 HTTP(Hyper Text Protocol)"

categories:
  - Javascript
tags:
  - [javascript, HTTP, Header , General Header  , Request Header, Response Header, Entity Header , GET , POST , PUT , DELETE , HTTP 상태 코드 , CORS]
...
1. *[HTTP 메서드](https://developer.mozilla.org/ko/docs/Web/HTTP/Methods)*
