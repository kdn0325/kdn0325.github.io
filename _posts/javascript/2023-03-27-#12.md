...
[![Array - JavaScript | MDN](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/MDN_Web_Docs_logo.svg/100px-MDN_Web_Docs_logo.svg.png)](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Array)
...
1. push() 메서드는 배열의 끝에 하나 이상의 요소를 추가하고, 배열의 새로운 길이를 반환합니다.(원본이 바뀜)
    ...
    [![Array.prototype.push() - JavaScript | MDN](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/MDN_Web_Docs_logo.svg/100px-MDN_Web_Docs_logo.svg.png)](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Array/push)

    
2. pop() 메서드는 배열에서 마지막 요소를 제거하고 그 요소를 반환합니다.
    
    [![Array.prototype.pop() - JavaScript | MDN](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/MDN_Web_Docs_logo.svg/100px-MDN_Web_Docs_logo.svg.png)](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Array/pop)
    
3. unshift() 메서드는 새로운 요소를 배열의 맨 앞쪽에 추가하고, 새로운 길이를 반환합니다.
    
    [![Array.prototype.unshift() - JavaScript | MDN](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/MDN_Web_Docs_logo.svg/100px-MDN_Web_Docs_logo.svg.png)](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Array/unshift)
    
4. shift() 메서드는 배열에서 첫 번째 요소를 제거하고, 제거된 요소를 반환합니다. 이 메서드는 배열의 길이를 변하게 합니다.
    
    [![Array.prototype.shift() - JavaScript | MDN](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/MDN_Web_Docs_logo.svg/100px-MDN_Web_Docs_logo.svg.png)](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Array/shift)
...
1. **`Array.isArray()`** 메서드는 인자가`Boolean`인지 판별합니다.(반환은 Boolean값)
    
    [![Array.isArray() - JavaScript | MDN](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/MDN_Web_Docs_logo.svg/100px-MDN_Web_Docs_logo.svg.png)](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Array/isArray)
    
2. **`concat()`** 메서드는 인자로 주어진 배열이나 값들을 기존 배열에 합쳐서 새 배열을 반환합니다.
    
    [![Array.prototype.concat() - JavaScript | MDN](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/MDN_Web_Docs_logo.svg/100px-MDN_Web_Docs_logo.svg.png)](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Array/concat)
...
3. **`slice()`** 메서드는 어떤 배열의 `begin` 부터 `end` 까지(`end` 미포함)에 대한 얕은 복사본을 새로운 배열 객체로 반환합니다. 
    ...
    [![Array.prototype.slice() - JavaScript | MDN](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/MDN_Web_Docs_logo.svg/100px-MDN_Web_Docs_logo.svg.png)](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Array/slice)
...
4. **`splice()`** 메서드는 배열의 기존 요소를 삭제 또는 교체하거나 새 요소를 추가하여 배열의 내용을 변경합니다.
    ...
    [![Array.prototype.splice() - JavaScript | MDN](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/MDN_Web_Docs_logo.svg/100px-MDN_Web_Docs_logo.svg.png)](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Array/splice)
